...
//Includes
include_once( WPAPP_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-config.php' );
include_once( WPAPP_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-request-api.php' );
include_once( WPAPP_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-request-api-injector.php' );
include_once( WPAPP_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-js-button-embed.php' );
include_once( WPAPP_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-subsc-billing-plan.php' );
include_once( WPAPP_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-webhook.php' );
include_once( WPAPP_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-webhook-event-handler.php' );
include_once( WPAPP_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-onapprove-ipn-handler.php' );
include_once( WPAPP_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-utility-functions.php' );//Misc project specific utility functions.
include_once( WPAPP_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-utility-ipn-related.php' );//Misc IPN related utility functions.
include_once( WPAPP_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-cache.php' );
include_once( WPAPP_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-bearer.php' );
include_once( WPAPP_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-button-ajax-handler.php' );
include_once( WPAPP_PLUGIN_PATH . 'lib/paypal/class-tthq-paypal-acdc-related.php' );

//Onboarding related includes
include_once( WPAPP_PLUGIN_PATH . 'lib/paypal/onboarding-related/class-tthq-paypal-onboarding.php' );//PPCP Onboarding related functions.
include_once( WPAPP_PLUGIN_PATH . 'lib/paypal/onboarding-related/class-tthq-paypal-onboarding-serverside.php' );//PPCP Onboarding serverside helper.
...
new PayPal_Main(
    array(
        'plugin_shortname' => 'wpapp',
        'api_connection_settings_page' => 'options-general.php?page=wordpress-easy-paypal-payment-or-donation-accept-plugin/admin/wpapp_admin_menu.php&action=ppcp-settings&subtab=api-connection', // REPACE: Need to change this across different plugins.
        'log_text_method' => 'wpapp_log_payment_debug',
        'log_array_method' => 'wpapp_log_debug_array',
        'ppcp_settings_key' => 'wpapp_paypal_ppcp_settings',
		'enable_sandbox_settings_key' => 'wpapp_enable_sandbox',
    )
);